...
//    private static List<NIOConnection> conns = new ArrayList<>();
...
//    public static final void close(NIOConnection conn) {
////        if(conn != null){
////            conn.close();
////            conns.remove(conn);
////        }
